...
<div ng-controller="public.roomCtrl">
    ...
    <div class="fluid-container relacionados bg-blanco">
            <div class="container">
                    ...
                    <div class="product-container col-md-3 col-sm-6 col-xs-12">
                            <div class="producto oferta-rojo">
                                    <div class="timer-subasta"></div>
                                    <div class="img-subasta">
                                            <img src="img/productos/producto02.png" alt="Producto 2" title="Producto 2">
                                    </div>
                                    <div class="leyenda-subasta">
                                            <div>Puedes subastar desde:</div>
                                            <div class="rango-ofertas">$0000.00 - $0000.00</div>
                    ...
                    <div class="product-container col-md-3 col-sm-6 col-xs-12">
                            <div class="producto oferta-naranja">
                                    <div class="timer-subasta"></div>
                                    <div class="img-subasta">
                                            <img src="img/productos/producto01.png" alt="Producto 1" title="Producto 1">
                                    </div>
