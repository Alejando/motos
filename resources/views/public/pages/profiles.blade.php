					...
					<form class="login-form">
						<div class="row">
							<div class="col-sm-6">
							  <div class="form-group row">
							    <div class="col-sm-12">
							    	<div class="row">
								    	<div class="col-sm-6">
								      		<input type="text" name="nombre" class="form-control2" placeholder="Nombre">
								      	</div>
								      	<div class="col-sm-6 margen-tf">
								      		<input type="text" name="apellido" class="form-control2" placeholder="Apellido">
								      	</div>
							      	</div>
							    </div>
							  </div>
							  <div class="form-group row">
							    <div class="col-sm-12">
							      <input type="email" name="correo" class="form-control2" placeholder="Correo electrónico">
							    </div>
							  </div>
							  <div class="form-group row">
							    <div class="col-sm-12">
							    	<select name="sexo" class="form-control2">
							    ...
							    <div class="col-sm-12">
							    	<div class="row">
							    		<div class="col-xs-4 nac">
							    			<select name="dia" class="form-control2" placeholder="Día">
							    		...
							    		<div class="col-xs-4 nac margen-nac">
							    			<select name="mes" class="form-control2" placeholder="Mes">
							    		...
							    		<div class="col-xs-4 nac">
							    			<select name="year" class="form-control2" placeholder="Año">
						 ...
						 <div class="checkbox text-center">
							    <label>
							      <input type="checkbox"> Acepto los <a href="javascript:void(0);">Términos y Condiciones</a>
							    </label>
							  </div>
						 <div class="form-group row">
