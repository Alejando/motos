...
@section('message')
            ...
            <div class="mensaje" style="color: #003937; padding: 0 5%;">
                <p style="margin: 16px auto;">
                    Te confirmamos que hemos recibido el pago de tu máxima oferta por adquirir:
                </p>
                ...
                <div style="width: 100%; display: inline-block; font-size: 20px;font-size: 12px; text-align: left;margin-left: 10px;vertical-align: middle; margin-bottom:20px;">
                    <div style="width: 50%; display: inline-block; text-align: center;"> 
                        <div style="color: #d5a00f;">
                            Monto final ofertado:
                        </div>
                        <div style="color: #003937; font-size: 20px;">
                            {{Currency::format($auction->sold_for, config('app.currency'))}}
                        </div>
                    </div><div style="width: 50%; display: inline-block; text-align: center;"> 
                        <div style="margin-top: 10px;">
                            Fecha de termino de la subasta:
                        </div>
                        <div style="color: #003937; font-size: 20px;">
                            {{Carbon\Carbon::parse($auction->end_date)->format('d/m/Y')}}
                        </div>
                    </div>
                </div>
                <div style="width: 80%; display: block; font-size: 15px; vertical-align: middle; text-align: left; margin:0 auto;">
                    <div style="display: inline-block;text-align: left;width: 40%;margin-left: 10%;">
                        Subtotal:
                    </div><div style="display: inline-block;text-align: right;color: #003937;width: 40%;">
