...
@section('message')
    ...
    <div class="total-pagar" style="background-color: #efefef; color: #00bcb6;padding: 20px 0;">
        ...
        <div style="width: 90%; display: inline-block; font-size: 20px; margin:0 auto;">
            <div style="width: 49%; display: inline-block;text-align: center;">
                Oferta final:
            </div><div style="width: 49%; display: inline-block; text-align: center;color: #003937;">
                {{Currency::format($auction->last_offer, config('app.currency'))}}
            </div>
        </div>
    </div>
