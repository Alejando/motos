var contacto = (function (window, undefined) {
    var mapa = function() {
        var lat = parseFloat(document.getElementById('lat').getAttribute('value'));
        var lng = parseFloat(document.getElementById('lng').getAttribute('value'));
        var zoom = parseInt(document.getElementById('zoom').getAttribute('value'));
        // console.log(lat);
        // console.log(lng);
        // console.log(zoom);
