...
Medidas: 17x23x7.5cm.',
                ...
                'category'=>GlimGlam\Models\Category::getByName('Joyeria')->id,
                'sub_category'=>GlimGlam\Models\Category::getByName('Aretes/Pulsera')->id,
                'target'=>0,
...
Hecho en Italia',
                ...
                'category'=>GlimGlam\Models\Category::getByName('Cartera')->id,
                'sub_category'=>null,
                'target'=>0,
                'marca'=>'Burberry',
                'code'=>'SUB007',
