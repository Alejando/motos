                        ...
                        <ul>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="#/catalogos/categorias"><i class="fa fa-tags"></i>Categorias</a></li>
                            ...
                            <li class="has_sub">
                                <a href="{{url("/")}}" class="waves-effect waves-light"><i class="fa fa-globe m-r-5"></i> <span> Tienda </span></a>
                            </li>
                            <li class="has_sub">
